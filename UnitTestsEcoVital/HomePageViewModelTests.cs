...
public class HomePageViewModelTests
{
    ...
    {
        var testDate = new DateTime(2024, 5, 7);
        Assert.Equal(DayOfWeek.Tuesday,
            testDate.DayOfWeek); // Esto debe ser verdadero, martes es DayOfWeek.Tuesday que es 2

        var testViewModel = new HomePageViewModel(testDate);

        // Esperando el consejo para el martes
        var expectedAdvice = "Tómate un tiempo para meditar y despejar tu mente.";
